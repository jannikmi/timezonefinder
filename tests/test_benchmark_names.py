...
EXPECTED_BENCHMARK_NAMES = EXPECTED_COMPARISON_NAMES | {
    ...
    "benchmarks/test_inside_polygon.py::test_pt_in_poly_clang_blocked[small]",
    "benchmarks/test_inside_polygon.py::test_pt_in_poly_clang_blocked[medium]",
    "benchmarks/test_inside_polygon.py::test_pt_in_poly_clang_blocked[large]",
    "benchmarks/test_inside_polygon.py::test_pt_in_poly_python_blocked[small]",
    "benchmarks/test_inside_polygon.py::test_pt_in_poly_python_blocked[medium]",
    "benchmarks/test_inside_polygon.py::test_pt_in_poly_python_blocked[large]",
