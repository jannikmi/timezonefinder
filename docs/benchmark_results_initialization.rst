...
* **Fastest configuration**: TimezoneFinderL (In-Memory) (446.9 ms)

* **Slowest configuration**: TimezoneFinder (In-Memory) (458.8 ms)

* **Performance difference**: 3% faster


* **File-based mode** is 1% faster (450.5 ms vs 452.9 ms)
