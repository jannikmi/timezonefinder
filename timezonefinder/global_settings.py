...
BIN_DATA_ATTRIBUTES_LOCAL = [UNIQUE_SHORTCUT_NAME, DIRECT_SHORTCUT_NAME]
BIN_FILES_LOCAL = [specifier + BINARY_FILE_ENDING for specifier in BIN_DATA_ATTRIBUTES_LOCAL]
TIMEZONE_NAMES = 'timezone_names.json'
HOLE_REGISTRY = 'hole_registry.json'
JSON_DATA_ATTRIBUTES_LOCAL = [TIMEZONE_NAMES, HOLE_REGISTRY]
JSON_FILES_LOCAL = [specifier + JSON_FILE_ENDING for specifier in JSON_DATA_ATTRIBUTES_LOCAL]

DATA_ATTRIBUTES_LOCAL = BIN_DATA_ATTRIBUTES_LOCAL + JSON_FILES_LOCAL
DATA_FILES_LOCAL = BIN_FILES_LOCAL + JSON_FILES_LOCAL
