...
tf = TimezoneFinder()
tfL = TimezoneFinderL()
functions = [tf.timezone_at, tf.certain_timezone_at, tf.closest_timezone_at, tfL.timezone_at, tfL.timezone_at_land,
             tf.timezone_at_land]
...
def main():
    ...
    parser.add_argument('-f', '--function', type=int, choices=[0, 1, 2, 3, 4, 5], default=0,
