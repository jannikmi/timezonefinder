...
* repaired the mangled lookup-speed cell of the `package comparison <https://timezonefinder.readthedocs.io/en/latest/alternatives.html>`__ table, where a documentation cross-reference had leaked into the table as literal text. Both sides of the row now say what was measured and on what
