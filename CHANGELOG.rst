...
* added ``shortcuts_unique_zone.fbs`` containing the precomputed "single-zone" shortcut map so lookups in uniquely covered hex cells return without polygon checks
