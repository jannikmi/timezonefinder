...
| [PERF-7](items/lookup-geometry-and-data-format/perf-7-answer-a-fully-covered-ambiguous-cell-without-geometry.md) | Answer a fully covered ambiguous cell without geometry | performance | M | needs a decision — worth 2.12 % of an ambiguous query, but ~824 of the 826 cells change which of two overlapping zones answers |
