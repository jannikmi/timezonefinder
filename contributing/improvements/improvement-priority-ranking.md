...
| [TOOL-1](items/data-pipeline-and-developer-tooling/tool-1-six-ruff-rule-families-are-enforced-nowhere.md) | Six ruff rule families are enforced nowhere, and the version bump waits on two | tooling | M | free — 75 sites to judge, then ~97 findings measured on 0.16.5 |
