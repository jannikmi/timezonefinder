...
| [TOOL-1](items/data-pipeline-and-developer-tooling/tool-1-two-ruff-rule-families-are-ignored-and-gate-the-version-bump.md) | Two ruff rule families are ignored, and the version bump waits on them | tooling | M | free — 46 sites to judge, then ~97 findings measured on 0.16.5 |
