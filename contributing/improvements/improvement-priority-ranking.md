...
| [FT-3](items/packaging-distribution-and-release/ft-3-raise-the-h3-floor-and-flip-the-gil-assertion.md) | Raise the `h3` floor and flip the GIL assertion | packaging | S | blocked on an h3 release carrying uber/h3-py#493 |
| [FT-5](items/packaging-distribution-and-release/ft-5-free-threaded-wheels.md) | Free-threaded wheels | packaging | M | needs — 3.15t only via `abi3t` (+3 artifacts, no growth) against 3.13t/3.14t as well (+6 now, +3 per release); `abi3t` also waits on a setuptools that accepts a free-threaded limited-API tag |
