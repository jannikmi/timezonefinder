...
- **Defect:** the rule is selected as part of `B` and then ignored again, so nothing holds any `zip` in the tree to a stated length contract. Re-measured 2026-09-06 on ruff 0.15.22: **27 sites across 18 files**.
