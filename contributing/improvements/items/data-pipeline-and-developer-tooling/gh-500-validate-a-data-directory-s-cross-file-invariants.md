...
- **Reuse it in the builder rather than duplicating it — the maintainer's condition on the move, and the point of doing it at all.**
  ...
  This extends the [generated-artifact rule](../../../development/generated-file-regeneration-rules.md)
  — assert in the generator *and* in the test suite, sharing one implementation — to a third caller,
  and the module is already written that way.
