...
- **Last touched:** 2026-08-31 — unblocked when the packaged binaries stopped being committed, and the last caveat removed the same day: a format branch now compiles its data in CI (`compile_data.yml`) rather than committing a regeneration, so the 46 coordinate blobs are all history and nothing adds a 47th. The rewrite no longer has to be timed against what is unmerged. Earlier: migrated from the roadmap issue on 2026-08-20.
