...
- **Sequenced under BENCH-2, not blocked by it.** If the pages move to CI, machine and environment stop differing on their own and what remains is selection, rounds and estimator. The assertion fix is independent of that decision and can be taken today.
