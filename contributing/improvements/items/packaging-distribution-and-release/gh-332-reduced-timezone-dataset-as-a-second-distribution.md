...
- **Decided, 2026-08-21 — parked until GH-334 unblocks.** Shipping with a hand-maintained mapping was declined: until the official table exists it is the same liability the zone-precedence engine was rejected for. GH-334 tracks the upstream trigger, so nothing else has to watch it.
