...
- **Status:** open — the precedence question is decided (above) and the route is measured; what is left is the converter change, the regenerated index and the moved-answer diff. Found 2026-09-07 while measuring polygon overlap for GH-301; nothing has been implemented.
