...
```
[data 2.x release] ─→ DATA-BINARIES ─→ GH-522
  (unblocked: the hold ended            (stop committing)  [strictly after]
   when the block index landed)
