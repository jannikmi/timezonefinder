...
- **DATA-BINARIES sequences before GH-449.** Once the binaries stop being committed, regeneration no longer adds ~61 MiB to this repository's history, which is what makes the rest of the data work cheap.
