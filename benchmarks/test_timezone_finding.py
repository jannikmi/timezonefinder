...
#
# The scalar part of the CI-tracked `benchmark_core` set is one representative
# headline plus two diagnostics. Uniformly random points are the headline
...
# public forms over the three strata used to separate lookup costs. Track all
# six so CI catches regressions that only affect the vectorised batch path.
BATCH_CASES = [
    pytest.param(
